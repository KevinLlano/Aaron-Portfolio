...
const getSocialIcon = (icon: string) => {
  const iconMap: { [key: string]: React.ReactNode } = {
    ...
    x: (
      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
        <path d="M17.53 2.47a.75.75 0 0 1 1.06 1.06l-5.22 5.22 5.22 5.22a.75.75 0 0 1-1.06 1.06l-5.22-5.22-5.22 5.22a.75.75 0 0 1-1.06-1.06l5.22-5.22-5.22-5.22A.75.75 0 0 1 6.25 2.47l5.22 5.22 5.22-5.22z" />
      </svg>
    ),
  ...
  return iconMap[icon.toLowerCase()] || <ExternalLink className="h-5 w-5" />;
};
